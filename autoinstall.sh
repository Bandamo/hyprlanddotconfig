...
yay -S --noconfirm minicom picocom htop neofetch firefox sshfs neovim tmux zsh oh-my-zsh-git openssh netcat nmap gnu-netcat vlc eog zathura zathura-pdf-mupdf thunar cmake make gcc gdb 
